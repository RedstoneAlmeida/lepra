...
namespace softmine\inventory;


use softmine\block\Planks;
use softmine\block\Quartz;
use softmine\block\Sandstone;
use softmine\block\Slab;
use softmine\block\Fence;
use softmine\block\Stone;
use softmine\block\StoneBricks;
use softmine\block\StoneWall;
use softmine\block\Wood;
use softmine\block\Wood2;
