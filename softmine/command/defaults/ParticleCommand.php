...
use softmine\level\particle\AngryVillagerParticle;
use softmine\level\particle\BubbleParticle;
use softmine\level\particle\CriticalParticle;
use softmine\level\particle\DustParticle;
use softmine\level\particle\EnchantmentTableParticle;
use softmine\level\particle\EnchantParticle;
use softmine\level\particle\ExplodeParticle;
use softmine\level\particle\FlameParticle;
use softmine\level\particle\HappyVillagerParticle;
use softmine\level\particle\HeartParticle;
use softmine\level\particle\HugeExplodeParticle;
use softmine\level\particle\InkParticle;
use softmine\level\particle\InstantEnchantParticle;
use softmine\level\particle\ItemBreakParticle;
use softmine\level\particle\LargeExplodeParticle;
use softmine\level\particle\LavaDripParticle;
use softmine\level\particle\LavaParticle;
use softmine\level\particle\Particle;
use softmine\level\particle\PortalParticle;
use softmine\level\particle\RainSplashParticle;
use softmine\level\particle\RedstoneParticle;
use softmine\level\particle\SmokeParticle;
use softmine\level\particle\SplashParticle;
use softmine\level\particle\SporeParticle;
use softmine\level\particle\TerrainParticle;
use softmine\level\particle\WaterDripParticle;
use softmine\level\particle\WaterParticle;
...
class ParticleCommand extends VanillaCommand{
	...
	public function __construct($name){
		parent::__construct(
			$name,
			"%softmine.command.particle.description",
			"%softmine.command.particle.usage"
		);
		$this->setPermission("softmine.command.particle");
	}
